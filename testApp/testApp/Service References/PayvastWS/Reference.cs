...
namespace testApp.PayvastWS {
    ...
    public interface AccountingServiceSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        testApp.PayvastWS.CustomerType[] GetCustomerTypes();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/GetCustomerTypes", ReplyAction="*")]
        System.Threading.Tasks.Task<testApp.PayvastWS.CustomerType[]> GetCustomerTypesAsync();
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        testApp.PayvastWS.Merchandise[] GetMerchandiseList(int fiscalPeriod);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/GetMerchandiseList", ReplyAction="*")]
        System.Threading.Tasks.Task<testApp.PayvastWS.Merchandise[]> GetMerchandiseListAsync(int fiscalPeriod);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        testApp.PayvastWS.AccountTransaction[] GetAccountTransactions(int fiscalPeriod, System.DateTime startDate, System.DateTime endDate, string account, string flowtingAccount1, string flowtingAccount2, string flowtingAccount3, string flowtingAccount4, string flowtingAccount5);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/GetAccountTransactions", ReplyAction="*")]
        System.Threading.Tasks.Task<testApp.PayvastWS.AccountTransaction[]> GetAccountTransactionsAsync(int fiscalPeriod, System.DateTime startDate, System.DateTime endDate, string account, string flowtingAccount1, string flowtingAccount2, string flowtingAccount3, string flowtingAccount4, string flowtingAccount5);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        testApp.PayvastWS.GetFiscalPeriodIdResponse GetFiscalPeriodId(testApp.PayvastWS.GetFiscalPeriodIdRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/GetFiscalPeriodId", ReplyAction="*")]
        System.Threading.Tasks.Task<testApp.PayvastWS.GetFiscalPeriodIdResponse> GetFiscalPeriodIdAsync(testApp.PayvastWS.GetFiscalPeriodIdRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface AccountingServiceSoapChannel : testApp.PayvastWS.AccountingServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AccountingServiceSoapClient : System.ServiceModel.ClientBase<testApp.PayvastWS.AccountingServiceSoap>, testApp.PayvastWS.AccountingServiceSoap {
        ...
        public testApp.PayvastWS.CustomerType[] GetCustomerTypes() {
            return base.Channel.GetCustomerTypes();
        }
        
        public System.Threading.Tasks.Task<testApp.PayvastWS.CustomerType[]> GetCustomerTypesAsync() {
        ...
        public testApp.PayvastWS.Merchandise[] GetMerchandiseList(int fiscalPeriod) {
            return base.Channel.GetMerchandiseList(fiscalPeriod);
        }
        
        public System.Threading.Tasks.Task<testApp.PayvastWS.Merchandise[]> GetMerchandiseListAsync(int fiscalPeriod) {
        ...
        public testApp.PayvastWS.AccountTransaction[] GetAccountTransactions(int fiscalPeriod, System.DateTime startDate, System.DateTime endDate, string account, string flowtingAccount1, string flowtingAccount2, string flowtingAccount3, string flowtingAccount4, string flowtingAccount5) {
        ...
        public System.Threading.Tasks.Task<testApp.PayvastWS.AccountTransaction[]> GetAccountTransactionsAsync(int fiscalPeriod, System.DateTime startDate, System.DateTime endDate, string account, string flowtingAccount1, string flowtingAccount2, string flowtingAccount3, string flowtingAccount4, string flowtingAccount5) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        testApp.PayvastWS.GetFiscalPeriodIdResponse testApp.PayvastWS.AccountingServiceSoap.GetFiscalPeriodId(testApp.PayvastWS.GetFiscalPeriodIdRequest request) {
        ...
        public System.Nullable<int> GetFiscalPeriodId(System.Nullable<System.DateTime> date) {
            testApp.PayvastWS.GetFiscalPeriodIdRequest inValue = new testApp.PayvastWS.GetFiscalPeriodIdRequest();
            inValue.date = date;
            testApp.PayvastWS.GetFiscalPeriodIdResponse retVal = ((testApp.PayvastWS.AccountingServiceSoap)(this)).GetFiscalPeriodId(inValue);
            return retVal.GetFiscalPeriodIdResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<testApp.PayvastWS.GetFiscalPeriodIdResponse> testApp.PayvastWS.AccountingServiceSoap.GetFiscalPeriodIdAsync(testApp.PayvastWS.GetFiscalPeriodIdRequest request) {
            return base.Channel.GetFiscalPeriodIdAsync(request);
        }
        
        public System.Threading.Tasks.Task<testApp.PayvastWS.GetFiscalPeriodIdResponse> GetFiscalPeriodIdAsync(System.Nullable<System.DateTime> date) {
            testApp.PayvastWS.GetFiscalPeriodIdRequest inValue = new testApp.PayvastWS.GetFiscalPeriodIdRequest();
            inValue.date = date;
            return ((testApp.PayvastWS.AccountingServiceSoap)(this)).GetFiscalPeriodIdAsync(inValue);
        }
    }
}
